...
export class DailyJobPostingCheck implements Job {
  private repo = getJobPostingRepository();
  private bus = getEventBus();
  private daysAhead = 3; // Default: check for jobs expiring in the next 3 days
