...
export { Cache, append, cleanupExpired, clear, decrement, del, deleteMany, entries, get, getEntry, getMany, has, increment, isEmpty, keys, merge, mutate, peek, randomKey, set, setMany, size, sizeInBytes, startCleanup, stopCleanup, upsert, values };
